...
export function NonNegotiables({ compact = false }: NonNegotiablesProps) {
  ...
  if (compact) {
    return (
      <div className="flex flex-wrap gap-2 py-2 px-3 border-[3px] border-foreground rounded-[24px] bg-card">
  ...
  return (
    <div className="border-[3px] border-foreground rounded-[24px] bg-card overflow-hidden">
      <div className="flex items-center gap-2 px-4 py-3 border-b-[3px] border-foreground">
        <Shield className="h-5 w-5 text-foreground" />
        <span className="font-serif font-bold text-sm tracking-wide text-foreground uppercase">
          Non-Negotiables
        </span>
      </div>
